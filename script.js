...
const projectVisuals = {
  ...
  "logistics-rag": `
    <div class="rag-scene">
      <div class="rag-doc">DOCS</div>
      <div class="rag-node"></div>
      <div class="rag-search">VECTOR SEARCH</div>
      <div class="rag-answer">GROUNDED ANSWER</div>
    </div>
  `,
  "enterprise-ai": `
    <div class="enterprise-scene">
      <div class="enterprise-core">AI</div>
      <div class="enterprise-item item-1">POLICY</div>
      <div class="enterprise-item item-2">IT TICKET</div>
      <div class="enterprise-item item-3">LEAVE</div>
      <div class="enterprise-item item-4">KNOWLEDGE</div>
    </div>
  `,
  "arabic-news": `
